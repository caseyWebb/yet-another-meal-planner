...
// The recipe authoring schema = the HUMAN-AUTHORED frontmatter fields only, in
// authoring order. Derived fields (e.g. `description`, generated by the Worker into
// D1 — see the derived-recipe-metadata capability) are deliberately ABSENT: no human
// authors them, so the vault offers no control for them. `vocab` names the controlled
// set a Select/Multi binds to; omit it for a free-form field (Input/Number/open Multi).
// Keep this the human-authored subset of src/recipe-contract.js REQUIRED_FIELDS.
export const FIELD_SPECS = Object.freeze([
  ...
  { name: "ingredients_key", type: "Multi" },
  { name: "dietary", type: "Multi" },
  { name: "season", type: "Multi", vocab: "season" }, // constrained
  { name: "requires_equipment", type: "Multi", vocab: "equipment" }, // constrained
  { name: "tags", type: "Multi" },
  { name: "pairs_with", type: "Multi" },
  { name: "perishable_ingredients", type: "Multi" },
  { name: "side_search_terms", type: "Multi" },
]);
