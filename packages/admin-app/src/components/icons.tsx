// Ported from src/admin/ui/icons.tsx (hono/jsx) to React for the admin SPA (admin-spa D10 —
// inline Lucide SVG components, trimmed/carried over; no lucide-react dependency).
...
const Icon = ({ children, size = 16, className: cls }: { children?: React.ReactNode; size?: number; className?: string }) => (
  <svg
...
export const ChevronDownIcon = ({ size, className: cls }: { size?: number; className?: string }) => (
  <Icon size={size} className={cls}>
    <path d="m6 9 6 6 6-6" />
  </Icon>
);

export const ChevronRightIcon = ({ size, className: cls }: { size?: number; className?: string }) => (
  <Icon size={size} className={cls}>
...
/** Half-sun/half-moon theme-toggle glyph (the design bundle's theme control). */
export const SunMoonIcon = ({ size }: { size?: number }) => (
  <Icon size={size}>
