// The order operation's PURE DATA shapes (order-placement / member-app-grocery D9): a
...
// the worker-typed module graph. The runtime modules re-export these (matching.ts:
