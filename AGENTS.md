...
- [AGENT_INSTRUCTIONS.md](packages/worker/AGENT_INSTRUCTIONS.md) - member-facing agent persona source; not auto-loaded into dev sessions.
...
- `AGENT_INSTRUCTIONS.md` is the persona source. The plugin bundle is generated by `packages/worker/scripts/build-plugin.mjs`; never hand-edit generated plugin output.
