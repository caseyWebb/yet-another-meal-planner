...
(client-routed: a Status home area for service health, a Members area for member management,
a Dev area for the MCP tool console) served at `/admin`, talking to the same-origin
`/admin/api/*` JSON surface. We chose
