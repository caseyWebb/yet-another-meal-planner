...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.e$, request.aG, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {da: fragment, di: host, cn: path, dM: port_, dQ: protocol, dR: query};
	});
...
var $elm$url$Url$Parser$State = F5(
	function (visited, unvisited, params, frag, value) {
		return {aA: frag, aC: params, aw: unvisited, em: value, aI: visited};
	});
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{eu: false, bq: r.bq, a0: r.a0, eO: r.eO, e$: r.e$, fy: r.fy, fA: r.fA, aG: r.aG}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{bq: $elm$http$Http$emptyBody, a0: r.a0, eO: _List_Nil, e$: 'GET', fy: $elm$core$Maybe$Nothing, fA: $elm$core$Maybe$Nothing, aG: r.aG});
};
...
var $author$project$Config$Flyer$Config = F3(
	function (minFlyerDiscount, flyerRefreshHours, flyerBatchUnits) {
		return {ak: flyerBatchUnits, al: flyerRefreshHours, cf: minFlyerDiscount};
	});
...
var $author$project$Data$Corpus$Listing = F2(
	function (prefix, entries) {
		return {c4: entries, ba: prefix};
	});
var $author$project$Data$Corpus$Entry = F2(
	function (name, kind) {
		return {Y: kind, bD: name};
	});
...
var $author$project$Data$Table$init = F2(
	function (group, tables) {
		...
		if (!_v0.$) {
			var first = _v0.a;
			return _Utils_Tuple2(
				{aV: first, bz: group, aP: $krisajenkins$remotedata$RemoteData$Loading, bd: tables},
				A2($author$project$Data$Table$fetch, group, first));
		} else {
			return _Utils_Tuple2(
				{aV: '', bz: group, aP: $krisajenkins$remotedata$RemoteData$NotAsked, bd: tables},
	...
	A9(
		...
		F8(
			function (id, profile, pantry, mealPlan, groceryList, overlay, cookingLog, recipeNotes) {
				return {bZ: cookingLog, b6: groceryList, aM: id, cb: mealPlan, ck: overlay, cl: pantry, cp: profile, cq: recipeNotes, bN: _List_Nil};
			}),
...
var $author$project$Data$Member$selectionFor = $elm$core$Maybe$map(
	function (id) {
		return {bw: $krisajenkins$remotedata$RemoteData$Loading, aM: id};
	});
...
var $author$project$Data$Recipe$RecipeDetail = F9(
	function (slug, tier, source, projection, description, hasEmbedding, dispositions, notes, body) {
		return {bq: body, c_: description, c1: dispositions, df: hasEmbedding, dI: notes, dP: projection, bc: slug, d7: source, eh: tier};
	});
...
var $author$project$Data$Recipe$ListEntry = F3(
	function (slug, title, status) {
		return {bc: slug, bM: status, bh: title};
	});
...
var $author$project$Data$Recipe$selectionFor = function (selectedSlug) {
	return A2(
		$elm$core$Maybe$map,
		function (slug) {
			return {bw: $krisajenkins$remotedata$RemoteData$Loading, bc: slug};
		},
		selectedSlug);
};
var $author$project$Data$Recipe$init = function (selectedSlug) {
	return _Utils_Tuple2(
		{
			bB: $krisajenkins$remotedata$RemoteData$Loading,
...
var $author$project$Dev$ToolConsole$Tool = F3(
	function (name, description, schema) {
		return {c_: description, bD: name, bb: schema};
	});
...
var $author$project$Logs$Entry = F8(
	function (id, url, title, source, outcome, slug, detail, createdAt) {
		return {b_: createdAt, bw: detail, aM: id, bE: outcome, bc: slug, d7: source, bh: title, aG: url};
	});
...
var $author$project$Status$HealthPayload = F6(
	function (ok, generatedAt, jobs, d1Ok, admin, aiQuotaExhausted) {
		return {bV: admin, cF: aiQuotaExhausted, cV: d1Ok, db: generatedAt, ds: jobs, dK: ok};
	});
var $author$project$Status$AdminPosture = F4(
	function (accessConfigured, emailAllowlist, devBypassSet, exposed) {
		return {cD: accessConfigured, c0: devBypassSet, c3: emailAllowlist, b4: exposed};
	});
...
var $author$project$Status$Job = F4(
	function (name, state, lastRunAt, summary) {
		return {dv: lastRunAt, bD: name, ea: state, ee: summary};
	});
...
var $author$project$Status$init = _Utils_Tuple2(
	{a1: $krisajenkins$remotedata$RemoteData$Loading, bU: $elm$time$Time$utc},
	$elm$core$Platform$Cmd$batch(
		_List_fromArray(
			[
...
var $author$project$Usage$KvUsage = F3(
	function (limits, totals, namespaces) {
		return {a2: limits, dA: namespaces, bi: totals};
	});
var $author$project$Usage$KvCounts = F4(
	function (read, write, _delete, list) {
		return {bv: _delete, bB: list, bF: read, bT: write};
	});
...
var $author$project$Usage$NamespaceUsage = F2(
	function (namespaceId, counts) {
		return {cU: counts, cg: namespaceId};
	});
...
var $author$project$Usage$init = _Utils_Tuple2(
	{bj: $krisajenkins$remotedata$RemoteData$Loading, bm: $krisajenkins$remotedata$RemoteData$Loading},
	$elm$core$Platform$Cmd$batch(
		_List_fromArray(
	...
	return A2(
		...
		A2(
			...
			_Utils_update(
				url,
				{
					cn: $author$project$Route$stripTrailingSlash(url.cn)
				})));
};
var $author$project$Main$init = F3(
	function (_v0, url, key) {
		return A3(
			...
			{bn: $author$project$Main$defaultDevSection, X: key, aP: $author$project$Main$NotFoundPage, ah: $author$project$Route$NotFound});
	});
...
var $author$project$Data$goto = F2(
	function (dataRoute, model) {
		var _v0 = _Utils_Tuple2(dataRoute, model.bL);
		_v0$5:
		while (true) {
			switch (_v0.a.$) {
				case 0:
...
var $elm$http$Http$post = function (r) {
	return $elm$http$Http$request(
		{bq: r.bq, a0: r.a0, eO: _List_Nil, e$: 'POST', fy: $elm$core$Maybe$Nothing, fA: $elm$core$Maybe$Nothing, aG: r.aG});
};
var $author$project$Admin$Members$krogerLink = function (username) {
	return $elm$http$Http$post(
		{
			bq: $elm$http$Http$emptyBody,
			a0: A2(
				$elm$http$Http$expectJson,
...
var $author$project$Admin$Members$Credentials = F3(
	function (username, inviteCode, connectorUrl) {
		return {cR: connectorUrl, dn: inviteCode, aS: username};
	});
...
var $author$project$Config$Calibration$extractFloorWarning = function (err) {
	if (err.$ === 3) {
		return $elm$core$Maybe$Just(
			{c8: 'unknown', cd: 'A value is below the safe floor. Confirm to override.'});
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
...
var $author$project$Config$Calibration$AnalyzeResult = F5(
	function (deltaPairCount, deltaTopPairs, deltaBounded, deltaCorpusSize, memberTau) {
		return {cX: deltaBounded, cY: deltaCorpusSize, cZ: deltaPairCount, b1: deltaTopPairs, cc: memberTau};
	});
...
var $author$project$Config$Calibration$DryRunOutcome = F6(
	function (url, title, source, outcome, slug, wouldMatchMembers) {
		return {bE: outcome, bc: slug, d7: source, bh: title, aG: url, eq: wouldMatchMembers};
	});
...
var $author$project$Config$Flyer$configToDraft = function (c) {
	return {
		...
		a6: $elm$core$String$fromFloat(c.cf * 100)
	};
};
var $author$project$Config$Flyer$defaultConfig = {ak: 12, al: 24, cf: 0.05};
...
var $author$project$Config$TableEditor$SampleOutcome = F3(
	function (url, outcome, status) {
		return {bE: outcome, bM: status, aG: url};
	});
...
var $author$project$Config$update = F2(
	function (msg, model) {
		var _v0 = _Utils_Tuple2(msg, model.bL);
		switch (_v0.a.$) {
			case 0:
				if (!_v0.b.$) {
					var sub = _v0.a.a;
	...
	function (msg, model) {
		if (!msg.$) {
			...
			return _Utils_Tuple2(
				...
				A2($author$project$Data$Table$fetch, model.bz, name));
		} else {
			var page = msg.a;
			return _Utils_Tuple2(
				_Utils_update(
...
var $author$project$Dev$SchemaExample$toField = F2(
	function (required, _v1) {
		...
		var value = _v1.b;
		return {
			b0: A2($author$project$Dev$SchemaExample$maybeField, 'default', value),
...
var $author$project$Dev$SchemaExample$renderField = F3(
	function (level, inherit, field) {
		...
		var line = $author$project$Dev$SchemaExample$indent(level) + ('\"' + (field.bD + ('\": ' + (A3($author$project$Dev$SchemaExample$fieldValue, level, commented, field) + (',' + $author$project$Dev$SchemaExample$hintComment(field))))));
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						$elm$core$List$isEmpty(r.b1) ? $elm$html$Html$text('') : A2(
						$elm$html$Html$div,
						_List_Nil,
						_List_fromArray(
							[
								...
								A2(
									...
									A2($elm$core$List$map, $author$project$Config$Calibration$viewTopPair, r.b1)))
							])),
						A2(
						$elm$html$Html$h3,
						_List_Nil,
						...
						A2(
							...
							A2($elm$core$List$map, $author$project$Config$Calibration$viewMemberTau, r.cc)))
					]));
	}
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						_Utils_Tuple2('outcome-imported', o.bE === 'imported'),
						_Utils_Tuple2('outcome-error', o.bE === 'error')
					]))
			]),
		_List_fromArray(
			[
...
var $author$project$Config$TableEditor$viewSample = function (sample) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$text(
				sample.aG + (' — ' + (sample.bE + $author$project$Config$TableEditor$statusSuffix(sample.bM))))
			]));
};
var $author$project$Config$TableEditor$viewVerdict = function (verdict) {
	var total = $elm$core$List$length(verdict.bK);
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						verdict.by.dT ? ('Feed reachable — ' + ($elm$core$String$fromInt(verdict.by.dq) + ' items')) : ('Feed unreachable' + $author$project$Config$TableEditor$statusSuffix(verdict.by.bM)))
					])),
				(!total) ? A2(
				$elm$html$Html$p,
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$ul,
						_List_Nil,
						A2($elm$core$List$map, $author$project$Config$TableEditor$viewSample, verdict.bK))
					]))
			]));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Config$viewSection(model.bL)
			]));
};
...
var $author$project$Data$Corpus$viewEntry = F2(
	function (prefix, entry) {
		var full = _Utils_ap(prefix, entry.bD);
		return A2(
			$elm$html$Html$li,
			_List_fromArray(
				[
...
var $dillonkearns$elm_markdown$Markdown$Renderer$defaultHtmlRenderer = {
	...
	b3: function (children) {
		return A2($elm$html$Html$em, _List_Nil, children);
	},
	b7: A2($elm$html$Html$br, _List_Nil, _List_Nil),
	b8: function (_v3) {
		var level = _v3.dw;
		var children = _v3.cN;
		switch (level) {
	...
	cy: $elm$html$Html$thead(_List_Nil),
	...
	bO: $elm$html$Html$tr(_List_Nil),
	m: $elm$html$Html$text,
	cB: A2($elm$html$Html$hr, _List_Nil, _List_Nil),
	cC: function (items) {
		return A2(
			$elm$html$Html$ul,
			_List_Nil,
...
var $dillonkearns$elm_markdown$Markdown$OrderedList$ListItem = F4(
	function (order, intended, marker, body) {
		return {bq: body, eU: intended, e_: marker, fg: order};
	});
...
var $dillonkearns$elm_markdown$Markdown$Parser$orderedListBlock = function (previousWasBody) {
	return A2(
		$elm$parser$Parser$Advanced$map,
		function (item) {
			return A6($dillonkearns$elm_markdown$Markdown$RawBlock$OrderedListBlock, true, item.eU, item.e_, item.fg, _List_Nil, item.bq);
		},
...
var $elm$regex$Regex$Match = F4(
	function (match, index, number, submatches) {
		return {d: index, a5: match, fb: number, cv: submatches};
	});
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$regMatchToAngleBracketLToken = function (regMatch) {
	...
	if ((_v0.b && _v0.b.b) && (!_v0.b.a.$)) {
		...
		return $dillonkearns$elm_markdown$Markdown$Helpers$isEven(backslashesLength) ? $elm$core$Maybe$Just(
			{d: regMatch.d + backslashesLength, ca: 1, f: $dillonkearns$elm_markdown$Markdown$InlineParser$AngleBracketOpen}) : $elm$core$Maybe$Nothing;
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$regMatchToCodeToken = function (regMatch) {
	...
	if ((_v0.b && _v0.b.b) && (!_v0.b.a.$)) {
		...
		return $elm$core$Maybe$Just(
			{
				d: regMatch.d + backslashesLength,
				ca: $elm$core$String$length(backtick),
	...
	while (true) {
		if (_v0.b) {
			if (!_v0.a.$) {
				...
				return (!$dillonkearns$elm_markdown$Markdown$Helpers$isEven(backslashesLength)) ? $elm$core$Maybe$Just(
					{d: (regMatch.d + backslashesLength) - 1, ca: 2, f: $dillonkearns$elm_markdown$Markdown$InlineParser$HardLineBreakToken}) : $elm$core$Maybe$Nothing;
			} else {
				if (_v0.b.b && (!_v0.b.a.$)) {
					var _v1 = _v0.b;
					return $elm$core$Maybe$Just(
						{
							d: regMatch.d,
							ca: $elm$core$String$length(regMatch.a5),
	...
	while (true) {
		if (_v0.b) {
			if (!_v0.a.$) {
				...
				var backslashesLength = $elm$core$String$length(backslashes);
				return $dillonkearns$elm_markdown$Markdown$Helpers$isEven(backslashesLength) ? $elm$core$Maybe$Just(
					{d: regMatch.d + backslashesLength, ca: 1, f: $dillonkearns$elm_markdown$Markdown$InlineParser$HardLineBreakToken}) : $elm$core$Maybe$Just(
					{d: (regMatch.d + backslashesLength) - 1, ca: 2, f: $dillonkearns$elm_markdown$Markdown$InlineParser$HardLineBreakToken});
			} else {
				if (_v0.b.b) {
					var _v1 = _v0.b;
					return $elm$core$Maybe$Just(
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$regMatchToLinkImageCloseToken = function (regMatch) {
	...
	if ((_v0.b && _v0.b.b) && (!_v0.b.a.$)) {
		...
		var backslashesLength = A2(
			...
			A2($elm$core$Maybe$map, $elm$core$String$length, maybeBackslashes));
		return $dillonkearns$elm_markdown$Markdown$Helpers$isEven(backslashesLength) ? $elm$core$Maybe$Just(
			{d: regMatch.d + backslashesLength, ca: 1, f: $dillonkearns$elm_markdown$Markdown$InlineParser$SquareBracketClose}) : $elm$core$Maybe$Nothing;
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$regMatchToLinkImageOpenToken = function (regMatch) {
	...
	if (((_v0.b && _v0.b.b) && _v0.b.b.b) && (!_v0.b.b.a.$)) {
		...
		if (isEscaped) {
			...
			if (!maybeImageOpen.$) {
				return $elm$core$Maybe$Just(
					{d: index, ca: 2, f: $dillonkearns$elm_markdown$Markdown$InlineParser$ImageOpenToken});
			} else {
				return $elm$core$Maybe$Just(
					{
						d: index,
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$regMatchToStrikethroughToken = function (regMatch) {
	...
	if ((_v0.b && _v0.b.b) && (!_v0.b.a.$)) {
		...
		var meaning = _v2.b;
		return $elm$core$Maybe$Just(
			{d: regMatch.d + backslashesLength, ca: length, f: meaning});
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
					...
					$elm$parser$Parser$Advanced$succeed(
						F3(
							function (startOffset, htmlTag, endOffset) {
								return {dj: htmlTag, ca: endOffset - startOffset};
							})),
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$isCodeTokenPair = F2(
	function (closeToken, openToken) {
		...
		if (!_v0.$) {
			if (!_v0.a) {
				var _v1 = _v0.a;
				return _Utils_eq(openToken.ca - 1, closeToken.ca);
			} else {
				var _v2 = _v0.a;
				return _Utils_eq(openToken.ca, closeToken.ca);
			}
		} else {
			return false;
		}
	...
	function (closeToken, openToken) {
		...
		if (_v0.$ === 7) {
			...
			if (_v1.$ === 7) {
				var closeChar = _v1.a;
				var close = _v1.b;
				return _Utils_eq(openChar, closeChar) ? ((_Utils_eq(open.bA, open.bH) || _Utils_eq(close.bA, close.bH)) ? ((!(!A2($elm$core$Basics$modBy, 3, closeToken.ca + openToken.ca))) || ((!A2($elm$core$Basics$modBy, 3, closeToken.ca)) && (!A2($elm$core$Basics$modBy, 3, openToken.ca)))) : true) : false;
			} else {
				return false;
			}
		} else {
	...
	function (closeToken, openToken) {
		var _v0 = function () {
			...
			if (_v1.$ === 9) {
				if (!_v1.a) {
					var _v2 = _v1.a;
					return _Utils_Tuple2(true, openToken.ca - 1);
				} else {
					var _v3 = _v1.a;
					return _Utils_Tuple2(true, openToken.ca);
				}
			} else {
		...
		var _v4 = function () {
			...
			if (_v5.$ === 9) {
				if (!_v5.a) {
					var _v6 = _v5.a;
					return _Utils_Tuple2(true, closeToken.ca - 1);
				} else {
					var _v7 = _v5.a;
					return _Utils_Tuple2(true, closeToken.ca);
				}
			} else {
				return _Utils_Tuple2(false, 0);
			}
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$tokenToMatch = F2(
	function (token, type_) {
		return {i: token.d + token.ca, v: _List_Nil, k: token.d, m: '', L: 0, x: 0, o: type_};
	});
	...
	function (closeToken, matches, references, rawText, _v32) {
		...
		var updatedOpenToken = function () {
			...
			if ((!_v33.$) && (!_v33.a)) {
				...
				return _Utils_update(
					openToken,
					{d: openToken.d + 1, ca: openToken.ca - 1});
			} else {
				return openToken;
			}
		}();
	...
	function (remaining, tokens, matches, references, rawText) {
		...
		while (true) {
			if (!remaining.b) {
				...
				if (_v27.$ === 7) {
					var _char = _v27.a;
					var leftFringeRank = _v27.b.bA;
					var rightFringeRank = _v27.b.bH;
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$emphasisToMatch = F5(
	function (references, rawText, closeToken, tokensTail, _v25) {
		...
		var remainLength = openToken.ca - closeToken.ca;
		var updt = (!remainLength) ? {bt: closeToken, a8: openToken, bG: remainTokens, bR: tokensTail} : ((remainLength > 0) ? {
			bt: closeToken,
			a8: _Utils_update(
				openToken,
				{d: openToken.d + remainLength, ca: closeToken.ca}),
			bG: A2(
				$elm$core$List$cons,
				_Utils_update(
					openToken,
			...
			bR: A2(
				...
				_Utils_update(
					closeToken,
					{d: closeToken.d + openToken.ca, ca: -remainLength}),
				tokensTail)
		});
		var match = A7(
			$dillonkearns$elm_markdown$Markdown$InlineParser$tokenPairToMatch,
			...
			$dillonkearns$elm_markdown$Markdown$InlineParser$EmphasisType(updt.a8.ca),
			updt.a8,
			updt.bt,
			$elm$core$List$reverse(innerTokens));
		return _Utils_Tuple3(updt.bR, match, updt.bG);
	});
			...
			return A3(
				...
				F2(
					function (headerCell, alignment) {
						return {bp: alignment, _: headerCell};
					}),
				headers,
				columnAlignments);
		};
...
var $dillonkearns$elm_markdown$Parser$Token$backtick = A2(
	...
	'`',
	$elm$parser$Parser$Expecting('a \'`\''));
var $dillonkearns$elm_markdown$Markdown$CodeBlock$backtick = {br: '`', Y: 0, bQ: $dillonkearns$elm_markdown$Parser$Token$backtick};
	...
	function (minLength, fenceCharacter) {
		var builtTokens = A3(
			...
			A2(
				...
				minLength,
				$elm$parser$Parser$Advanced$token(fenceCharacter.bQ)));
		return A2(
			$elm$parser$Parser$Advanced$mapChompedString,
			F2(
				function (str, _v0) {
			...
			A2(
				...
				builtTokens,
				$elm$parser$Parser$Advanced$chompWhile(
					$elm$core$Basics$eq(fenceCharacter.br))));
	});
...
var $dillonkearns$elm_markdown$Parser$Token$tilde = A2(
	...
	'~',
	$elm$parser$Parser$Expecting('a `~`'));
var $dillonkearns$elm_markdown$Markdown$CodeBlock$tilde = {br: '~', Y: 1, bQ: $dillonkearns$elm_markdown$Parser$Token$tilde};
			...
			$elm$parser$Parser$Advanced$succeed(
				F2(
					function (indent, _v0) {
						var character = _v0.a;
						var length = _v0.b;
						return {bs: character, b9: indent, ca: length};
					})),
		...
		_List_fromArray(
			[
				...
				A2(
					...
					$elm$parser$Parser$Advanced$succeed(
						$elm$parser$Parser$Advanced$Done(body)),
					A2($dillonkearns$elm_markdown$Markdown$CodeBlock$closingFence, fence.ca, fence.bs))),
				A2(
				$elm$parser$Parser$Advanced$keeper,
				A2(
					$elm$parser$Parser$Advanced$keeper,
					A2(
						...
						$dillonkearns$elm_markdown$Markdown$CodeBlock$codeBlockLine(fence.b9)),
					$elm$parser$Parser$Advanced$getOffset),
	...
	function (fence) {
		return A2(
			...
			A2(
				...
				A2(
					$elm$parser$Parser$Advanced$ignorer,
					$dillonkearns$elm_markdown$Markdown$CodeBlock$infoString(fence.bs),
					$dillonkearns$elm_markdown$Helpers$lineEndOrEnd)),
		...
		function (listmarker, unparsedListItem) {
			switch (unparsedListItem.$) {
				...
				case 1:
					...
					return {bq: body, e_: listmarker, p: $elm$core$Maybe$Nothing};
				default:
					return {bq: '', e_: listmarker, p: $elm$core$Maybe$Nothing};
			}
		});
	return A2(
		$elm$parser$Parser$Advanced$map,
					...
					A2(
						...
						$elm$core$List$reverse(
							A2(
								$elm$core$List$map,
								function (item) {
									return A2(parseItem, item.p, item.bq);
								},
								unparsedItems))));
			case 4:
				var tight = rawBlock.a;
			...
			case 6:
				...
				return $dillonkearns$elm_markdown$Markdown$Parser$ParsedBlock(
					$dillonkearns$elm_markdown$Markdown$Block$CodeBlock(
						{bq: codeBlockBody, eW: $elm$core$Maybe$Nothing}));
			case 8:
				var _v22 = rawBlock.a;
				var header = _v22.a;
				var rows = _v22.b;
	...
	return function (block) {
		switch (block.$) {
			...
			case 7:
				...
				return $elm$core$Maybe$Just(
					$elm$core$Result$Ok(
						renderer.bX(codeBlock)));
			case 8:
				return $elm$core$Maybe$Just(
					$elm$core$Result$Ok(renderer.cB));
			case 3:
								...
								renderer.bO(
									A2(
										...
										function (_v10) {
											...
											var item = _v10.b;
											return A2(renderer.cz, maybeAlignment, item);
										},
										listListView))));
					},
					renderedHeaderCells);
...
var $dillonkearns$elm_markdown$Markdown$Renderer$renderSingleInline = F2(
	function (renderer, inline) {
		switch (inline.$) {
			...
			case 8:
				return $elm$core$Maybe$Just(
					$elm$core$Result$Ok(renderer.b7));
			default:
				var html = inline.a;
				if (!html.$) {
					var tag = html.a;
...
var $author$project$Data$Member$viewMember = function (detail) {
	return A2(
		...
		_List_fromArray(
			[
				A2($author$project$Data$Member$valueSection, 'Profile', detail.cp),
				A2($author$project$Data$Member$listSection, 'Pantry', detail.cl),
				A2($author$project$Data$Member$listSection, 'Meal plan', detail.cb),
				A2($author$project$Data$Member$listSection, 'Grocery list', detail.b6),
				A2($author$project$Data$Member$listSection, 'Overlay (favorites / rejects)', detail.ck),
				A2($author$project$Data$Member$listSection, 'Cooking log', detail.bZ),
				A2($author$project$Data$Member$listSection, 'Recipe notes (authored)', detail.cq),
				A2($author$project$Data$Member$listSection, 'Store notes (authored)', detail.bN)
			]));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Data$Recipe$viewRenderedBody(detail.bq),
				A2(
				$author$project$Data$Recipe$section,
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Data$Recipe$statusBadge(entry.bM)
					])),
				A2(
				$elm$html$Html$td,
				_List_Nil,
...
var $author$project$Data$Recipe$view = function (model) {
	...
	if (!_v0.$) {
		...
		return $author$project$Data$Recipe$viewList(model.bB);
	}
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Data$viewSection(model.bL)
			]));
};
		...
		_Utils_ap(
			_List_fromArray(
				[
					...
					'outcome',
					$author$project$Logs$outcomeLabel(entry.bE))
				]),
			_Utils_ap(
				...
				_Utils_ap(
					...
					_Utils_ap(
						...
						_Utils_ap(
							A2($author$project$Logs$maybeRow, 'at', entry.b_),
							_List_fromArray(
								[
									A2(
									$elm$html$Html$div,
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$elm$html$Html$text(
													A2($elm$json$Json$Encode$encode, 2, entry.bw))
												]))
										]))
								])))))));
};
...
var $author$project$Logs$hasDetail = function (entry) {
	return (!_Utils_eq(entry.bc, $elm$core$Maybe$Nothing)) || (!$author$project$Logs$isEmptyDetail(entry.bw));
};
...
var $author$project$Logs$viewEntryRow = F2(
	function (rowAction, entry) {
		...
		var _v0 = $author$project$Logs$outcomeClassWord(entry.bE);
		var cls = _v0.a;
		var word = _v0.b;
		return A2(
			$elm$html$Html$li,
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text(
							A2($elm$core$Maybe$withDefault, '', entry.b_))
						])),
					$author$project$Logs$isRetryable(entry.bE) ? A2(
					$elm$html$Html$span,
					_List_fromArray(
						[
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2($author$project$Status$viewBody, model.bU, model.a1)
			]));
};
...
var $author$project$Usage$kvCountsLabel = function (c) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$core$String$fromInt(c.bF),
				$elm$core$String$fromInt(c.bT),
				$elm$core$String$fromInt(c.bv),
				$elm$core$String$fromInt(c.bB)
			]));
};
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('status-label'),
								$elm$html$Html$Attributes$title(ns.cg)
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(ns.cg)
							])),
						A2(
						$elm$html$Html$span,
						_List_fromArray(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Cloudflare usage for ' + (data.b$ + ' (UTC), against the daily free-tier limits.'))
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						A3($author$project$Usage$meterRow, 'reads', data.Z.bi.bF, data.Z.a2.bF),
						A3($author$project$Usage$meterRow, 'writes', data.Z.bi.bT, data.Z.a2.bT),
						A3($author$project$Usage$meterRow, 'deletes', data.Z.bi.bv, data.Z.a2.bv),
						A3($author$project$Usage$meterRow, 'lists', data.Z.bi.bB, data.Z.a2.bB)
					])),
				...
				_List_fromArray(
					[
						...
						A3($author$project$Usage$meterRow, 'neurons', data.bo.dD, data.bo.dC),
						$author$project$Usage$viewByModel(data.bo.cL)
					]))
			]));
};
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text(
								$author$project$Usage$sparkline(jt.bu))
							])),
						A2(
						$elm$html$Html$span,
						_List_fromArray(
						...
						_List_fromArray(
							[
								...
								$elm$core$String$fromInt(totalRuns) + (' runs · ' + ($author$project$Usage$formatMs(
									$author$project$Usage$weightedAvgMs(jt.bu)) + ' avg')))
							]))
					]))
			]));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Usage$viewBody(model.bm),
				$author$project$Usage$viewTrends(model.bj)
			]));
};
	...
	switch (_v0.$) {
		...
		case 2:
			...
			return A2(
				...
				_List_fromArray(
					[
						$author$project$Main$viewDevSubnav(model.bn),
						A2(
						$elm$html$Html$section,
						_List_fromArray(
							[
