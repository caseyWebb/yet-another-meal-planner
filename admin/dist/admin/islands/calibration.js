...
// src/admin/lib/remote.ts
var notAsked = { status: "notAsked" };
var loading = { status: "loading" };
var failure = (error) => ({ status: "failure", error });
var success = (value) => ({ status: "success", value });

// src/admin/client/calibration.tsx
...
async function floorWarning(res) {
  const body = await res.json().catch(() => null);
  if (body?.detail?.needsConfirm) return { field: body.detail.field ?? "", message: body.message ?? "Below the safe floor." };
  return null;
}
function CalibrationIsland({ config }) {
  const [saved, setSaved] = useState(config);
  const [form2, setForm] = useState({ t: "clean" });
  const [analyze, setAnalyze] = useState(notAsked);
  const [dryRun, setDryRun] = useState(notAsked);
  const currentDraft = () => form2.t === "clean" ? toDraft(saved) : form2.draft;
  ...
  async function save(confirm) {
    const draft2 = currentDraft();
    const res = await client.admin.api.discovery.config.$put({ json: { ...toPatch(draft2), confirm } });
    if (res.ok) {
    ...
    if (warning) setForm({ t: "needsConfirm", draft: draft2, warning });
  }
  const draft = currentDraft();
  const dirty = form2.t !== "clean";
  return /* @__PURE__ */ jsxDEV("div", { children: [
    /* @__PURE__ */ jsxDEV("div", { class: "card", children: [
      /* @__PURE__ */ jsxDEV("fieldset", { style: "border:0;padding:0;margin:0", children: KNOBS.map((k) => /* @__PURE__ */ jsxDEV("label", { children: [
        k.label,
        /* @__PURE__ */ jsxDEV(
          "input",
          {
            ...
            step: k.step,
            value: draft[k.key],
            onInput: (e) => onField(k.key, e.target.value)
          }
        )
      ] })) }),
      form2.t === "needsConfirm" ? /* @__PURE__ */ jsxDEV("div", { class: "confirm", children: [
        /* @__PURE__ */ jsxDEV("p", { children: form2.warning.message }),
        /* @__PURE__ */ jsxDEV("div", { class: "form-actions", children: [
          /* @__PURE__ */ jsxDEV("button", { class: "danger-solid", onClick: () => save(true), children: "Confirm & save" }),
          /* @__PURE__ */ jsxDEV("button", { class: "link", onClick: () => setForm({ t: "dirty", draft: form2.draft }), children: "Cancel" })
        ] })
      ] }) : /* @__PURE__ */ jsxDEV("div", { class: "form-actions", children: [
        /* @__PURE__ */ jsxDEV("button", { disabled: !dirty, onClick: () => save(false), children: "Save" }),
        /* @__PURE__ */ jsxDEV("button", { class: "link", onClick: runAnalyze, children: "Analyze" }),
        /* @__PURE__ */ jsxDEV("button", { class: "link", onClick: runDryRun, children: "Dry-run" })
      ] })
    ] }),
    /* @__PURE__ */ jsxDEV(AnalyzePanel, { state: analyze }),
    /* @__PURE__ */ jsxDEV(DryRunPanel, { state: dryRun })
  ] });
}
var AnalyzePanel = ({ state }) => {
  if (state.status === "notAsked") return null;
  if (state.status === "loading") return /* @__PURE__ */ jsxDEV("p", { class: "muted", children: "Analyzing\u2026" });
  if (state.status === "failure") return /* @__PURE__ */ jsxDEV("div", { class: "error", children: [
    "Analyze failed: ",
    state.error.message
  ] });
  const a = state.value;
  return /* @__PURE__ */ jsxDEV("div", { class: "card", children: [
    /* @__PURE__ */ jsxDEV("h2", { children: "Analyze" }),
    /* @__PURE__ */ jsxDEV("p", { class: "muted small", children: [
      "\u03B4 pairs: ",
      a.deltaPairCount,
      a.deltaBounded ? " (sampled)" : "",
      " \xB7 corpus ",
      a.deltaCorpusSize
    ] }),
    /* @__PURE__ */ jsxDEV("table", { children: [
      /* @__PURE__ */ jsxDEV("thead", { children: /* @__PURE__ */ jsxDEV("tr", { children: [
        ...
        /* @__PURE__ */ jsxDEV("th", { children: "matches at \u03C4" })
      ] }) }),
      /* @__PURE__ */ jsxDEV("tbody", { children: a.memberTau.map((m) => /* @__PURE__ */ jsxDEV("tr", { children: [
        /* @__PURE__ */ jsxDEV("td", { children: m.tenant }),
        /* @__PURE__ */ jsxDEV("td", { children: [
          m.matchCount,
          m.coldStart ? /* @__PURE__ */ jsxDEV("span", { class: "muted small", children: " (cold start)" }) : null
        ] })
      ] })) })
    ] })
  ] });
};
var DryRunPanel = ({ state }) => {
  if (state.status === "notAsked") return null;
  if (state.status === "loading") return /* @__PURE__ */ jsxDEV("p", { class: "muted", children: "Running the pipeline (no writes)\u2026" });
  if (state.status === "failure") return /* @__PURE__ */ jsxDEV("div", { class: "error", children: [
    "Dry-run failed: ",
    state.error.message
  ] });
  return /* @__PURE__ */ jsxDEV("div", { class: "card", children: [
    /* @__PURE__ */ jsxDEV("h2", { children: "Dry-run" }),
    state.value.length === 0 ? /* @__PURE__ */ jsxDEV("p", { class: "muted", children: "No candidates this run." }) : /* @__PURE__ */ jsxDEV("ul", { class: "entry-list", children: state.value.map((o) => /* @__PURE__ */ jsxDEV("li", { class: "entry-row", children: [
      /* @__PURE__ */ jsxDEV("span", { class: "entry-outcome muted", children: o.outcome }),
      /* @__PURE__ */ jsxDEV("span", { class: "entry-title", children: o.title || o.url }),
      /* @__PURE__ */ jsxDEV("span", { class: "entry-source muted small", children: o.wouldMatchMembers && o.wouldMatchMembers.length > 0 ? `\u2192 ${o.wouldMatchMembers.join(", ")}` : "" })
    ] })) })
  ] });
};
...
if (host && propsEl) {
  ...
  render(/* @__PURE__ */ jsxDEV(CalibrationIsland, { config: props.config }), host);
}
