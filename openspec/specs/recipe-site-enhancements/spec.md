# recipe-site-enhancements Specification

## Purpose

Defines progressive-enhancement features layered on top of the zero-JavaScript recipe site: metadata search reflected in the URL, a tap-to-advance read-aloud mode for instruction steps, and offline/installable PWA support. Each feature is additive and SHALL NOT impair the JavaScript-disabled baseline.
