...
- **Authored markdown (GitHub, data-repo root)** — the ONLY tier a human hand-edits (Obsidian / native git apps): `recipes/*.md` (objective frontmatter + body) and `storage_guidance/*.md` (curated put-away advice).
